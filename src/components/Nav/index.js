        ...
        <div>
            <ul className="nav nav-tabs">
                ...
                <li className="nav-item dropdown">
                    <Link className="nav-link dropdown-toggle" data-bs-toggle="dropdown" to="#" role="button" aria-expanded="false">Currency Converter and Stock Charts</Link>
                    <ul className="dropdown-menu">
                        <li><Link className="dropdown-item" to="converter/currency">Currency Converter</Link></li>
                        <li><Link className="dropdown-item" to="stockcharts">Market Stock Charts</Link></li>
                ...
                <li><Link className="nav-link" to="symbolslist">Symbols List</Link></li>
                {
                    !user
                        ?
                        <li className="nav-item">
